...

{
  ...
  Serial.println("AT+CMGS=\"+212634124702\"");   // use your 10 digit cell no. here
...

{
    ...
    send_data("Luggage Tracking Alert:");

    send_data("Your luggage Current Location is:");
